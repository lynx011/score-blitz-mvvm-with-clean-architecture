...
class FixtureDetailsUseCase @Inject constructor(private val repository: ScoreRepository) {
    ...
    suspend operator fun invoke(
        ...
        return if (met.isEmpty() && firstTeamId.equals(null) && secondTeamId.equals(null) && apiKey.isEmpty()) flow { }
        else repository.getH2H(met, firstTeamId, secondTeamId, apiKey)
    }
    ...
    suspend operator fun invoke(
        ...
        return if (met.isEmpty() && leagueId.equals(null) && apiKey.isEmpty()) flow { }
        else repository.getStandings(met, leagueId, apiKey)
    }
}